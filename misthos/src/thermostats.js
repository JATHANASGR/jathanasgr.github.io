...
let g_RegMap =
{
    ...
    "42" :
    {
        ...
        "106"   : [0, 0, 65535, 1, "data-ir", "(I7) ΘΕΡΜ/ΜΑΓΝ. ΥΠΟΒΡΥΧΙΑΣ ΑΝΤΛΙΑΣ (ON) (0 = Κλειστή Επ. 1 = Ανοιχτή Επ.)"],
        "107"   : [0, 0, 65535, 1, "data-ir", "(I8) ΡΕΛΕ ΥΠΟΒΡΥΧΙΑΣ ΑΝΤΛΙΑΣ (ON) (0 = Κλειστή Επ. 1 = Ανοιχτή Επ.)"],
        "108"   : [8, 0, 65535, 1, "data-ir", "DI (Ασφ.δίοδης (I0), Ρελέ εντ. δίοδης OPENNING (I1), Ρελέ επιστ. δίοδης OPEN (I2), Ρελέ επιστ. δίοδης CLOSE (I3), Ασφ. Ρελέ (I4), Ασφ. ΜΣΧ (I5)) (0 = Κλειστή Επ. 1 = Ανοιχτή Επ.)"],
